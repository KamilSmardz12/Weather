...
<div class="align-items-center d-flex photo-overlay py-5 cover"
     style="background-image: url(&quot;pog.jpg&quot;); background-position: left top; background-size: 100%; background-repeat: repeat;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 p-3"
                ...
                <form class="p-4 bg-dark-opaque text-center" method="get" action="/Home">
                    <div class="form-group">
                        ...
                        <input type="text" class="text-center" value=<%=request.getAttribute("country")%> readonly = "
                        true">
                    </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="text-center" value=<%=request.getAttribute("city")%> readonly = "true
                        ">
                        ...
                        <div class="form-group"><label>&nbsp;<br></label>
                            ...
                            <input type="text" class="text-center"
                                   value=<%=request.getAttribute("temperature")%> readonly = "true">

                            <div class="form-group"><label>&nbsp;</label>
                                <h4 class="text-center"> Humidity</h4>
                                <input type="text" class=text-center
                                       value=<%=request.getAttribute("humidity")%> readonly = "true">

                                <div class="form-group"><label>&nbsp;</label>
                                    <h4 class="text-center"> Pressure</h4>
                                    <input type="text" class="text-center"
                                           value=<%=request.getAttribute("pressure")%> readonly = "true">
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="submit" href="/displayWether" class="btn mt-4 btn-block p-2 btn-outline-info"><b>Back
                        to home page</b></button>
                </form>
            </div>
        </div>
    </div>
